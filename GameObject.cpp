...
// GoldenIdol class implementation

GoldenIdol::GoldenIdol() : GameObject("the golden idol") {}

GoldenIdol::~GoldenIdol() {}

// Weapon class implementation

Weapon::Weapon(const string& name, const string& action, int dexterityBonus, int damageAmount)
    : GameObject(name), mAction(action), mWeaponDexterityBonus(dexterityBonus), mWeaponDamageAmount(damageAmount) {}
...
// Weapon derived classes implementation
...
// Scroll derived classes implementation
